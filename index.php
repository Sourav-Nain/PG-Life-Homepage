    ...
    <div class="major-cities">
      <a href="PG-Life-Property-Listing/index.php?city=Mumbai">
        <div class="cities">
          <div
            class="city-logo"
            style="background-image: url(&quot;mumbai.png&quot;)"
          ></div>
        </div>
      </a>
      <a href="PG-Life-Property-Listing/index.php?city=Delhi">
        <div class="cities">
          <div
            class="city-logo"
            style="background-image: url(&quot;delhi.png&quot;)"
          ></div>
        </div>
      </a>
      <a href="PG-Life-Property-Listing/index.php?city=Bengaluru">
        <div class="cities">
          <div
            class="city-logo"
            style="background-image: url(&quot;bangalore.png&quot;)"
          ></div>
        </div>
      </a>
      <a href="PG-Life-Property-Listing/index.php?city=Chennai">
        <div class="cities">
          <div
            class="city-logo"
            style="background-image: url(&quot;chennai.png&quot;)"
          ></div>
        </div>
      </a>
    </div>
